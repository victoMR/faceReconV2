...
export default function App() {
 ...
 const startCamera = async () => {
  try {
    ...
    console.log("Pistas activas:", stream.getTracks());
    ...
    if (videoRef.current) {
      ...
      videoRef.current.onloadedmetadata = () => {
        console.log("🎞️ Metadata cargada, haciendo play...");
        videoRef.current.play().catch((err) => console.error("Play error:", err));
      };
    } else {
      console.warn("⚠️ videoRef está null en el momento del stream.");
    }
        ...
        <div className="bg-white border border-green-200 shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="pt-6 pb-4 px-6">
            ...
            <div className="flex flex-col items-center space-y-4">
              <div className="relative w-full h-[300px] rounded-lg overflow-hidden border-4 border-green-600">
  <video
    ref={videoRef}
    autoPlay
    playsInline
  ...
  {!isCameraActive && (
    <div className="absolute inset-0 bg-green-50 border-2 border-dashed border-green-300 flex items-center justify-center">
  ...
  {isRecognizing && (
    <div className="absolute inset-0 flex items-center justify-center bg-black/50">
      <div className="flex flex-col items-center space-y-2">
        ...
        <p className="text-white font-medium">Reconociendo...</p>
      </div>
    </div>
  )}
</div>
